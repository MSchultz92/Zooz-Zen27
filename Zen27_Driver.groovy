 ...
 * 2019-05-04 - Ported to HE from https://github.com/doncaruana/SmartThings-doncaruana/tree/master/devicetypes/doncaruana/zooz-zen27-dimmer.src
...
metadata {
	definition (name: "Zooz Zen27 Dimmer", namespace: "doncaruana", author: "Don Caruana", ocfDeviceType: "oic.d.light", mnmn: "Hubitat", vid: "generic-dimmer") {
 ...
 //zw:L type:1101 mfr:027A prod:A000 model:A002 ver:1.00 zwv:5.03 lib:03 cc:5E,26,85,8E,59,55,86,72,5A,73,70,9F,6C,7A role:05 ff:8600 ui:8604
	...
	preferences {
		input "ledIndicator", "enum", title: "LED Indicator", description: "On When... ", options:["on": "Switch On", "off": "Switch Off", "never": "Never", "always": "Always"], defaultValue: "off"
